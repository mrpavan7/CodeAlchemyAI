...
const Header = () => {
  ...
  const { logging, setLogging, isLogin, doSignOut } = useContext(Context)
    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        <a className="block w-[12rem] xl:mr-8" href="#hero">
          <div className="codelogo-container">
            <img src={assets.brainwave_logo} width={70} height={40} alt="Brainwave" />
            <p style={{ fontSize: '25px' }}>CodeAlchemy AI</p>
          </div>
        </a>
        ...
        {
          !isLogin ?
            <Button onClick={() => { setLogging(true) }} className="hidden lg:flex" to="#login">
              Sign in
            </Button> :
            <Button onClick={doSignOut} className="hidden lg:flex" to="#login">
              Sign out
            </Button>
        }
